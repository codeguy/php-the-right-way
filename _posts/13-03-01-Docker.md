...
There are some full PHP development environment for Docker. These tools were built to speed up the process of creating a PHP development environment with docker, so they provide a ready to use setup and many configurations to tweak the environmnet.
