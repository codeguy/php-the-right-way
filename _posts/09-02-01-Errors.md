...
Du kannst auch steuern, ob Fehler auf dem Bildschirm angezeigt (für die Entwicklung / dev) oder ausgeblendet und protokolliert werden (für die Produktion / prod). Weitere Informationen hierzu findest Du im Abschnitt [Error Reporting(Fehlerberichterstattung)][errorreport].
